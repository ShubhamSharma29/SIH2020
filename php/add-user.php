<?php
  ...
  //       $insert = "INSERT INTO admins (name, username, phone, email, DOB, password) 
  //       VALUES('$name','$username','$phone','$email','$DOB','$password')";
  ...
  //       else
  //       {
  //         echo"Error in connecting. " .mysqli_error($db);
  //       }
  //       mysqli_close($db);
  //  }
        ...
        <form method="POST" autocomplete="on">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <input type="tel" class="form-control"  name="phone" pattern="[0-9]{10}" required placeholder="Enter phone no">
                  </div>
                  <div class="form-group col-sm-6">
